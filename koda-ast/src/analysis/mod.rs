//! AST analysis: file structure summaries and call graph extraction.
//!
//! Pure functions with no I/O dependency beyond reading source files.
//! The MCP server (when the `mcp` feature is on) wraps these; in-process
...
pub use syntax_check::syntax_check;
